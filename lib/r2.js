 ...
 * Note: R2 requires public access enabled on the bucket for presigned URLs.
 * If that's not available, use streamFile() instead.
 */
...
/** Stream a file from R2 (returns readable stream for proxy download). */
...
module.exports = { configured, uploadFile, deleteFile, apkKey, getSignedUrl, streamFile };
